...
public class REL_Analitico extends javax.swing.JFrame {
    ...
    /**
     * @param itensVenda the value of itensVenda
     */
    public REL_Analitico() {
        initComponents();
    }

    REL_Analitico(ArrayList<ItemVenda> itensVenda) {
       initComponents();
        ...
        for (ItemVenda item : itensVenda) {
            dtm_Produtos.addRow(new String[]{
                ...
                String.valueOf(item.getQntProduto()),
                String.valueOf(item.getVlrUnitario() * item.getQntProduto())
            });
        }
    }
